...
public class Page6Activity extends AppCompatActivity {
    ...
    private void right() {
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Page6Activity.this, Page7Activity.class));
            }
        });
    }
    ...
    private void wrong1() {
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Page6Activity.this, FinalActivity.class));
            }
        });
    }
    ...
    private void back() {
        ...
        restartButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Page6Activity.this, MainActivity.class));
            }
        });
    }
}
